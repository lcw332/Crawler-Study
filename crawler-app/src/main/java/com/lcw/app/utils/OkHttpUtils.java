...
/**
 * Created By lcw332
 * Time : 2020 06 19 19:20
 * Describe :
 **/

/**
 * @author lcw332
 * Date 2020-06-18-9:55
 * Description: 网络请求工具类
 **/
public class OkHttpUtils {
    ...
    public static void main(String[] args) {
        String url = "https://openapi.tuyacn.com/v1.0/functions/kg";
        Map<String,String> map = new HashMap<>();
        map.put("access_token","75fe5f79b24d76a58b822973255ade13");
